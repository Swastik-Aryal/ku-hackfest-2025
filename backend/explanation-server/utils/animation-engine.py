...
Schema:
{
  "manim_code": string | null
    ...
    def compile_manim(self, code: str, scene_name: str):
        ...
        try:
            result = subprocess.run(
                ["manim", "-pql", MANIM_FILE, scene_name],
                capture_output=True,
                text=True
            )
            ...
            if result.returncode != 0:
                ...
                if fixed:
                    ...
                    self.compile_manim(fixed, scene_name)
            else:
...
def main():
    ...
    print("\n=== Compilation ===")
    engine.compile_manim(code, "TwoSourceWaves")
